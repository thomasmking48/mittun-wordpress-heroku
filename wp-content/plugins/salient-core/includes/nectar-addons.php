...
function nectar_custom_maps() {
			...
			'params' => array(
				...
				array(
					...
					"value" => array(
						...
						/*"Displace Filter & Fade In" => 'displace-filter-fade',
						"Displace Filter Loop" => 'displace-filter-loop'*/
					),
				),
				array(
					"type" => "checkbox",
	...
	if( class_exists('Salient_Portfolio') ) {
		$nectar_gallery_styles = array(
			 ...
			 esc_html__("Touch Enabled and Spaced (Flickity)", "salient-core") => "flickity_style",
	...
	vc_add_param("vc_gallery",array(
	      ...
	      "param_name" => "img_size",
	      "description" => esc_html__("Enter image size in pixels - e.g 600x400 (Width x Height) Or use WordPress image size names such as \"full\"", "salient-core"),
	      "dependency" => Array('element' => "source", 'value' => array('media_library'))
	));
