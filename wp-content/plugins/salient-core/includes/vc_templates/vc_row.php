<?php
  ...
  $nectar_using_VC_front_end_editor = ($nectar_using_VC_front_end_editor == 'true') ? true : false;
    ...
    // Begin row output.
	   echo'
		<div id="'. esc_attr($row_id) .'" '.$fullscreen_anchor_id.' data-midnight="'.esc_attr(strtolower($midnight_color)).'" '.$row_percent_padding_attr.' data-bg-mobile-hidden="'.esc_attr($background_image_mobile_hidden).'" class="wpb_row vc_row-fluid vc_row '. $top_level_class . $main_class . $disable_class . $equal_height_class . $parallax_class . $vertically_center_class . ' '. $class . '" '.$using_custom_text_color.' style="'.$style.'">';
      ...
      echo '<div class="full-page-inner-wrap-outer"><div class="full-page-inner-wrap" data-name="'.esc_attr($row_name).'" data-content-pos="'.esc_attr($full_screen_row_position).'"><div class="full-page-inner">';
		...
		// Row bg. 
		echo '<div class="row-bg-wrap" data-bg-animation="'.esc_attr($bg_image_animation).'"><div class="inner-wrap' . $using_image_class . '">';
