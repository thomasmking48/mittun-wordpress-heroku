	...
	public function get_validation_messages() {
		...
		if ( "picker" === $type ) {
			...
			if ( $this->is_required( $field ) ) {
				...
				$messages               = '"' . $this->get_id( $field ) . '-day": "<strong>' . $day_label . '</strong>: ' . $day_validation_message . '",' . "\n";
				...
				$messages                 .= '"' . $this->get_id( $field ) . '-month": "<strong>' . $month_label . '</strong>: ' . $month_validation_message . '",' . "\n";
				...
				$messages                .= '"' . $this->get_id( $field ) . '-year": "<strong>' . $year_label . '</strong>: ' . $year_validation_message . '",' . "\n";
			}
