...
class Forminator_Shortcode_Generator {
	...
	public function attach_button( $content ) {
		...
		// Button markup
		$html .= '<a id="forminator-generate-shortcode" class="button" data-editor="content"><span class="dashicons dashicons-welcome-add-page"></span>' . __( 'Add Form', Forminator::DOMAIN ) . '</a>';
	...
	public function print_markup() {
		?>
		<div id="forminator-popup" class="wpmudev-modal" style="display: none;">
