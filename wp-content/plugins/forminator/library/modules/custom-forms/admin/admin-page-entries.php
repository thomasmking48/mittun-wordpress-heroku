	...
	private function build_fields_mappers() {
		...
		foreach ( $fields as $field ) {
			...
			if ( 'name' === $field_type ) {
				...
				$mapper['sub_metas'][] = array(
					'key'                => 'mode',
					'label'              => __( 'Payment Mode', Forminator::DOMAIN ),
					'transform_callback' => 'strtoupper',
				);
				$mapper['sub_metas'][] = array(
					'key'                => 'status',
					'label'              => __( 'Payment Status', Forminator::DOMAIN ),
					'transform_callback' => 'ucfirst',
				);
				$mapper['sub_metas'][] = array(
					'key'                => 'amount',
					'label'              => __( 'Payment Amount', Forminator::DOMAIN ),
				);
				$mapper['sub_metas'][] = array(
					'key'                => 'currency',
					'label'              => __( 'Payment Currency', Forminator::DOMAIN ),
					'transform_callback' => 'strtoupper',
				);
