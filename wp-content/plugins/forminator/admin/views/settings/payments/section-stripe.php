			...
			<table class="sui-table" style="margin-top: 10px;">
				...
				<thead>
					...
					<tr>
						...
						<th><?php esc_html_e( 'Publishable Key', Forminator::DOMAIN ); ?></th>
					</tr>
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo esc_html( $stripe->get_test_key() ); ?></td>
					</tr>

					<tr>
						<td class="sui-table-title"><?php esc_html_e( 'Live', Forminator::DOMAIN ); ?></td>
						<td><?php echo esc_html( $stripe->get_live_key() ); ?></td>
					</tr>
							...
							<div class="fui-buttons-alignment">
								...
								<form class="forminator-settings-save">
									...
									<button
										...
										data-modal-content="<?php esc_attr_e( 'Are you sure want to disconnect your Stripe Account? This will affect the forms using the Stripe field.', Forminator::DOMAIN ); ?>"
